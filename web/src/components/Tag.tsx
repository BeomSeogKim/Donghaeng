...
/*
 * The Tag part (design/components/parts/12-tag.html) — the pill that labels a
 * row, and the same pill with a state, which is the filter chip.
 *
...
const TAG =
  'inline-flex items-center rounded-chip px-2 py-0.5 text-meta leading-snug whitespace-nowrap'
 ...
 */
const CHIP =
  'inline-flex min-h-8 items-center rounded-chip border px-3 text-meta font-semibold ' +
