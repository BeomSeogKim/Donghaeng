...
/*
 * The frame for the screens that are one short centered column: login, and the
 * two states the app can be in before it knows who you are.
 *
 * The ledger is not one of these — it is full-bleed, flush rows, edge to edge —
 * so this is not "the app shell". It exists so the three screens that genuinely
